...
/*FF_ENUM_PARAMS(n) represents typename T1, typename T2...
R(FF_ENUM_TYPES(n)) represents the type of function
*/
...
namespace ff{
  namespace details{
    ...
    ///! For function R (...)
    /*
     *  FF_EXTRACT_FUNC_TYPE_TRAITS(1)
     *  FF_EXTRACT_FUNC_TYPE_TRAITS(2)
     *  ...
     *  FF_EXTRACT_FUNC_TYPE_TRAITS(30)
     */
